...
def main() -> int:
    ...
    from app.services.sandbox_school_affairs_core_flow_seed import seed_affairs_core_flows
    db=get_sessionmaker()()
    try:
        ...
        print(json.dumps(seed_affairs_core_flows(db,SANDBOX_TID),ensure_ascii=False,indent=2)); return 0
    finally: db.close()
