...
def main() -> int:
    ...
    from app.services.sandbox_school_graduation_historical_seed import seed_graduation_historical_coverage
    ...
    try:
        ...
        print(json.dumps(seed_graduation_historical_coverage(db, SANDBOX_TID), ensure_ascii=False, indent=2))
        return 0
    finally:
        db.close()
