...
class InternshipEnterpriseApplicationDecision(PKMixin, TenantMixin, CommonMixin, Base):
    ...
    __table_args__ = (
        ...
        Index("ix_intern_enterprise_decision_effect", "tenant_id", "volunteer_group_id", "effect_status", "valid_until", "is_deleted"),
    )
    ...
    effect_status: Mapped[str] = mapped_column(String(20), nullable=False, default="ACTIVE", comment="ACTIVE/EXPIRED/SUPERSEDED/CONSUMED")
