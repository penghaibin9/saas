...
# GRADUATION_ADMIN 的内置数据范围是 SCHOOL；毕设学生建档需要从全校主档目录选择候选学生。
# 这里只决定公共目录/组织选择器的数据范围，具体动作仍由 /students 的 picker permission、
# 学生主档、导入导出和学工各自的精确权限继续 fail-closed，不因此授予跨域能力。
_TENANT_ALL_ROLES = {"SCHOOL_ADMIN", "PLATFORM_SUPER_ADMIN", "STUDENT_AFFAIRS_ADMIN",
                     ...
                     "FUNDING_TEACHER", "GRADUATION_ADMIN"}
