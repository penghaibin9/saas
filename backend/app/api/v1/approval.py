...
def approve(task_id: str, body: ApprovalActionRequest, user=Depends(get_current_user)):
...
def reject(task_id: str, body: ApprovalRejectRequest, user=Depends(get_current_user)):
...
def transfer(task_id: str, body: ApprovalTransferRequest, user=Depends(get_current_user)):
