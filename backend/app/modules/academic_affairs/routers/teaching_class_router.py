...
# Install explicit-topology protection here too so a later ensure/backfill cannot
# rewrite CO_TEACHER or split-week relations through the legacy PRIMARY synchronizer.
