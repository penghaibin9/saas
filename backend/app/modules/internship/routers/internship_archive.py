...
权限（P3）：材料检查/查看 internship.archive.view（含指导教师、督导只读）；
归档/生成包/撤销/导出 internship.archive.manage（管理员/学院负责人/就业教师）。
"""
...
def archive_detail(internship_id: int, user=Depends(require_permission(_P_VIEW))):
