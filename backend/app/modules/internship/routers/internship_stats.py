...
def stats_overview(college: Optional[str] = None, major: Optional[str] = None,
                   className: Optional[str] = None, user=Depends(require_permission(_P_VIEW))):
...
def stats_dimensions(user=Depends(require_permission(_P_VIEW))):
...
def stats_export(college: Optional[str] = None, major: Optional[str] = None,
                 className: Optional[str] = None, user=Depends(require_permission(_P_EXPORT))):
