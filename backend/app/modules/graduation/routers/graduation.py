...
_ACTION_PERMISSION_MAP = {
    ...
    "submitPlagiarism": "graduationDesign.plagiarism.submit",
    "setPlagiarismResult": "graduationDesign.plagiarism.result",
    "reviewPlagiarismDispute": "graduationDesign.plagiarism.dispute.review",
    "assignReview": "graduationDesign.manage",
    "submitReview": "graduationDesign.final.review",
    "returnReview": "graduationDesign.manage",
