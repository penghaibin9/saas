...
def downgrade() -> None:
    op.drop_table("t_school_major_standard_binding")
    op.drop_table("t_national_standard_section")
    op.drop_table("t_national_standard_document")
    op.drop_table("t_national_major_catalog")
    op.drop_table("t_national_standard_source")
