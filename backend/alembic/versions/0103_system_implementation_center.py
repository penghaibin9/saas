...
def downgrade() -> None:
    op.drop_table("t_system_implementation_check")
    op.drop_table("t_system_preset_installation")
    op.drop_table("t_system_implementation_section")
    op.drop_table("t_system_implementation_project")
