...
test('AA-011 Staff PC real-click creates term-bound batch, adds supply, publishes and opens', async ({ browser }, testInfo) => {
  ...
  // Gold Deep requires Staff PC to create a usable batch, not an orphan DRAFT.
  ...
  const evidencePath = path.resolve(here, '../academic-aa011-staff-browser-fixture.json')
