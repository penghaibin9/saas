...
test('O3 student PC preserves CAS and formal file identifiers', () => {
  ...
  assert.match(view, /clientSubmissionId: materialRequestId\.value/)
  assert.match(view, /materialRequestId\.value = materialFile\.value \? createRequestId\('orientation-material'\) : ''/)
  assert.match(view, /materialUploaded\.value \|\| await portalApi\.uploadOrientationMaterial/)
