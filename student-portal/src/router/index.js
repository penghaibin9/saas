...
const routes = [
  ...
  { path: '/guardian', name: 'guardian', meta: { public: true }, component: () => import('../views/guardian/GuardianView.vue') },
  {
    ...
    children: [
      ...
      { path: 'academic/selection', name: 'academic-selection', meta: { modulePath: 'academic' }, component: () => import('../views/academic/StudentSelectionView.vue') },
      ...
      { path: 'academic/recheck', name: 'academic-recheck', meta: { modulePath: 'academic' }, component: () => import('../views/academic/StudentRecheckView.vue') },
      ...
      academicSection('academic/credits', 'academic-credits', '学分修读', '学分修读', '核对已获学分、绩点和达成情况'),
