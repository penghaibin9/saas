...
const routes = [
  ...
  { path: '/account-security', name: 'account-security', component: () => import('../views/profile/AccountSecurityView.vue') },
  { path: '/guardian', name: 'guardian', meta: { public: true }, component: () => import('../views/guardian/GuardianView.vue') },
  {
    ...
    children: [
      ...
      { path: 'internship/volunteer-result', name: 'internship-volunteer-result', meta: { modulePath: 'internship' }, component: () => import('../views/internship/InternshipVolunteerResultView.vue') },
      ...
      // 正式入口独立成 /departure（不使用 /clearance——仓库里那是"清考"语义）。
