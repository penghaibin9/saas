  ...
  <view class="mini-login">
    ...
    <view class="auth-card">
      ...
      <view class="newcomer-entry" @click="openOrientationActivation">
        <view><text class="newcomer-entry__badge">新生首次使用</text><text class="newcomer-entry__title">录取身份核验并激活账号</text></view>
...
.newcomer-entry view { display: flex; flex-direction: column; gap: 3px; }.newcomer-entry__badge { color: #0f766e; font-size: 9px; font-weight: 700; }.newcomer-entry__title { color: #24445a; font-size: 12px; font-weight: 600; }.newcomer-entry__arrow { color: #0f766e; font-size: 24px; line-height: 1; }
