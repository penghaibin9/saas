...
export const teacherApi = {
  ...
  getAcademicWarningDetail: (id) => real.teacherAcademicWarningDetail(id),
  addAcademicWarningIntervention: (id, body) => real.teacherAcademicWarningIntervention(id, body),
