...
export const teacherApi = {
  ...
  getMySchedule: (params = {}) => real.acadTeacherScheduleMy(params),
  ...
  getMyClasses: (params = {}) => real.teacherMyClasses(params),
  ...
  followMentalReferral: (refId, content, version) => real.teacherMentalFollow(refId, content, version),
  escalateMentalReferral: (refId, content, version) => real.teacherMentalEscalate(refId, content, version),
  closeMentalReferral: (refId, conclusion, version) => real.teacherMentalClose(refId, conclusion, version),
  ...
  getWeeklyReports: (options = {}) => realFirstStrict(
    'teacher.internship',
    () => teacherSequentialV3.getInternshipReviewQueue(options),
    () => mockRequest({ reports: M.weeklyReports, abnormal: M.abnormalCheckins,
      pagination: { weeklyPage: 1, exceptionPage: 1, pageSize: 20,
        weeklyPendingTotal: M.weeklyReports.filter((item) => item.status === 'PENDING_REVIEW').length,
        weeklyOverdueTotal: M.weeklyReports.filter((item) => item.status === 'OVERDUE').length,
        exceptionTotal: M.abnormalCheckins.filter((item) => item.status === 'PENDING_HANDLE').length,
        weeklyHasMore: false, exceptionHasMore: false } })
  ),
  ...
  getGraduationProposalDetail: (id) => latestRead(`teacher:graduation:proposal:${id}`, () => real.gdTeacherProposalDetail(id)),
  getGraduationFinalDetail: (id) => latestRead(`teacher:graduation:final:${id}`, () => real.gdTeacherFinalDetail(id)),
  ...
  getGraduationMidtermDetail: (id) => latestRead(`teacher:graduation:midterm:${id}`, () => real.gdTeacherMidtermDetail(id)),
  ...
  getCampusWorkOrders: (params = {}) => real.teacherCampusWorkOrders(params),
  getCampusWorkOrderDetail: (id) => real.teacherCampusWorkOrderDetail(id),
  handleCampusWorkOrder: (id, body) => real.teacherCampusWorkOrderHandle(id, body),
  closeCampusWorkOrder: (id, body) => real.teacherCampusWorkOrderClose(id, body),
  getAcademicWarnings: (params = {}) => real.teacherAcademicWarnings(params),
  getAcademicWarningSummary: () => real.teacherAcademicWarningSummary(),
  getAcademicWarningDetail: (id, params = {}) => real.teacherAcademicWarningDetail(id, params),
  addAcademicWarningIntervention: (id, body, commandKey) => real.teacherAcademicWarningIntervention(id, body, commandKey),
  getAcademicWarningReceipt: (commandKey) => real.teacherAcademicWarningReceipt(commandKey),
  getGraduationDefenseArrangements: () => real.gdTeacherDefenseArrangements(),
  getGraduationGradeQueue: () => real.gdTeacherGradeQueue(),
  getGraduationGradeDetail: (id) => latestRead(`teacher:graduation:grade:${id}`, () => real.gdTeacherGradeDetail(id)),
  ...
  getMessages: () => realFirstStrict('teacher.messages', () => real.teacherMessagesReal(), () => mockRequest({ tabs: M.teacherMessageTabs, groups: M.teacherMessages })),
  markMessageRead: (id) => real.teacherMessageMarkRead(id),
  getOrientationCheckinPoints: () => real.teacherOrientationCheckinPoints(),
  orientationCheckinPreflight: (token) => real.teacherOrientationCheckinPreflight(token),
  orientationCheckinConfirm: (token, checkinPointId) => real.teacherOrientationCheckinConfirm(token, checkinPointId),
  ...
  followInternshipRisk: (riskId, body) => real.teacherInternshipRiskFollow(riskId, body),
  ...
  getAffairsLeavePending: (params = {}) => real.teacherAffairsLeavePending(params),
  getAffairsLeaveFollowup: (params = {}) => real.teacherAffairsLeaveFollowup(params),
  ...
  getAffairsAidPending: (params = {}) => real.teacherAffairsAidPending(params),
  ...
  getAffairsFundingPending: (params = {}) => real.teacherAffairsFundingPending(params),
  ...
  getWorkStudyPosts: (params = {}) => real.teacherAffairsWorkStudyPosts(params),
  getWorkStudyRecords: (params = {}) => real.teacherAffairsWorkStudyRecords(params),
  actWorkStudy: (recordId, body) => real.teacherAffairsWorkStudyAction(recordId, body),
  getWorkStudyMonthly: (recordId) => real.teacherAffairsWorkStudyMonthly(recordId),
  addWorkStudyMonthly: (recordId, body) => real.teacherAffairsWorkStudyMonthlyAdd(recordId, body),
  getAffairsLoans: (params = {}) => real.teacherAffairsLoans(params),
  actAffairsLoan: (loanId, body) => real.teacherAffairsLoanAction(loanId, body),
  getAffairsFeeReductions: (params = {}) => real.teacherAffairsFeeReductions(params),
  actAffairsFeeReduction: (feeId, body) => real.teacherAffairsFeeReductionAction(feeId, body),
  ...
  getAffairsDormPending: (params = {}) => real.teacherAffairsDormPending(params),
  ...
  getAcademicMyTasks: (params = {}) => real.teacherAcademicMyTasks(params),
  ...
  getAcademicScheduleChanges: (status, page, pageSize) => real.teacherAcademicScheduleChanges(status, page, pageSize),
  ...
  reviewAcademicDefer: (deferId, action, reason, expectedVersion) => real.teacherAcademicDeferReview(deferId, action, reason, expectedVersion),
  getScheduleChangePending: (page, pageSize, changeId) => real.teacherAcademicScheduleChangePending(page, pageSize, changeId),
  reviewScheduleChange: (changeId, action, comment, expectedVersion) => real.teacherAcademicScheduleChangeReview(changeId, action, comment, expectedVersion),
  getStatusChangePending: () => real.teacherAcademicStatusChangePending(),
  reviewStatusChange: (changeId, action, reason, expectedDecisionVersion) => real.teacherAcademicStatusChangeReview(changeId, action, reason, expectedDecisionVersion),
  ...
  getAttendanceSessions: (params = {}) => real.teacherAttendanceSessions(params),
  ...
  getAttendanceDetail: (sessionId, params = {}) => real.teacherAttendanceDetail(sessionId, params),
  ...
  getWorkloadDeclarations: (params) => real.teacherWorkloadMy(params),
  getWorkloadCommandReceipt: (commandKey) => real.teacherWorkloadCommandReceipt(commandKey),
