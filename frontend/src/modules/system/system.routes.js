...
const systemRoutes = {
  ...
  children: [
    ...
    },
    {
      ...
      name: 'system-platform-integrity',
      component: () => import('@/modules/system/views/SystemPlatformIntegrityView.vue'),
      meta: { moduleCode: 'SYSTEM', title: '完整性异常中心', requiresAuth: true,
