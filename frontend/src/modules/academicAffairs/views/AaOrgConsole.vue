<template>
  <ModulePageShell
    ...
    title="学院专业班级"
    subtitle="维护学院、专业与行政班，查看班级成员和组织变更。"
    :role-name="roleName"
  ...
  >
    ...
    <div class="mp-stack">
      <!-- 页签 -->
      <nav class="aa-tabs">
        <button v-for="t in tabs" :key="t.key" class="aa-tab" :class="{ 'is-active': tab === t.key }" :disabled="busy" :aria-current="tab === t.key ? 'page' : undefined"
...
export default {
    ...
    columns() {
      const map = {
        ...
        teaching: [{ key: 'teachingClassName', title: '教学班' }, { key: 'teachingClassCode', title: '代码' },
          ...
          { key: 'isMerged', title: '组成' }, { key: 'expectedStudents', title: '人数' }, { key: 'actions', title: '操作' }],
  ...
  methods: {
    ...
    closeAdjust() {
      ...
      if (!this.adjust.receipt && this.adjust.origin?.classId) {
