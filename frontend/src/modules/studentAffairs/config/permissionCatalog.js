...
export const STUDENT_AFFAIRS_PERMISSION_CATALOG = [
  ...
  permission('studentAffairs.leave.cancelLeaveConfirm', '销假确认', 'leave', 'MEDIUM', ROLE_TEMPLATES.manage, [], ['POST /student-affairs/leaves/*/cancel-confirm']),
  permission('studentAffairs.leave.overdue.handle', '逾期请假处置', 'leave', 'HIGH', ROLE_TEMPLATES.manage, [], ['POST /student-affairs/leaves/*/overdue']),
  permission('studentAffairs.leave.extension.approve', '续假审批', 'leave', 'HIGH', ROLE_TEMPLATES.manage, [], ['POST /student-affairs/leaves/*/extension-approve']),
  ...
  permission('studentAffairs.dorm.inspection.manage', '宿舍检查维护', 'dorm', 'MEDIUM', ROLE_TEMPLATES.manage, [], ['POST /student-affairs/dorm/checks']),
  ...
  permission('studentAffairs.aid.counselorReview', '困难认定辅导员审核', 'aid', 'HIGH', ROLE_TEMPLATES.read, [], ['POST /student-affairs/aid/*/counselor-review']),
  ...
  permission('studentAffairs.homeSchool.record.create', '家校联系记录', 'homeSchool', 'HIGH', ROLE_TEMPLATES.read, [], ['POST /student-affairs/family/*/contacts']),
