<template>
  ...
  >
    ...
    >
      <p class="mental-privacy-line">仅展示聚合数量，不提供学生个体明细。</p>
...
<style scoped>
.mental-privacy-line { margin:0;padding:0 0 8px;border-bottom:1px solid var(--line,var(--border-light));color:var(--text-tertiary);font-size:var(--font-size-xs) }
