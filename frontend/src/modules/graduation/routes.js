...
const graduationRoutes = {
  ...
  children: [
    ...
    { path: 'topic-changes/:id', name: 'graduation-topic-change-detail', component: () => import('@/modules/graduation/views/TopicChangeDetailView.vue'), meta: { moduleCode: 'GRADUATION', title: '变更申请详情', requiresAuth: true, permissionKey: 'graduationDesign.topic.change' } },
    { path: 'topic-changes', name: 'graduation-topic-changes', component: () => import('@/modules/graduation/views/TopicChangeRequestListView.vue'), meta: { moduleCode: 'GRADUATION', title: '题目调整（选题变更申请）', requiresAuth: true, permissionKey: 'graduationDesign.topic.change' } },
    ...
    { path: 'more/peer-assign', name: 'graduation-more-peer', component: () => import('@/modules/graduation/views/GraduationMorePeerView.vue'), meta: { moduleCode: 'GRADUATION', title: '分配成果互查', requiresAuth: true, permissionKey: 'graduationDesign.more.manage' } },
    { path: 'more/expert/create', name: 'graduation-more-expert', component: () => import('@/modules/graduation/views/GraduationMoreExpertView.vue'), meta: { moduleCode: 'GRADUATION', title: '新增答辩专家', requiresAuth: true, permissionKey: 'graduationDesign.more.manage' } },
    { path: 'more', name: 'graduation-more', component: () => import('@/modules/graduation/views/GraduationMoreView.vue'), meta: { moduleCode: 'GRADUATION', title: '互查/专家/申诉', requiresAuth: true, permissionKey: 'graduationDesign.more.manage' } },
    ...
    { path: 'mentors/create', name: 'graduation-mentor-create', component: () => import('@/modules/graduation/views/GraduationMentorFormView.vue'), meta: { moduleCode: 'GRADUATION', title: '申报导师', requiresAuth: true, permissionKey: 'graduationDesign.mentor.manage' } },
    { path: 'mentors/conflicts', name: 'graduation-mentor-conflicts', component: () => import('@/modules/graduation/views/GraduationMentorConflictsView.vue'), meta: { moduleCode: 'GRADUATION', title: '分配冲突检测', requiresAuth: true, permissionKey: 'graduationDesign.mentor.manage' } },
    { path: 'mentors/assign/:studentId', name: 'graduation-mentor-assign', component: () => import('@/modules/graduation/views/GraduationMentorAssignView.vue'), meta: { moduleCode: 'GRADUATION', title: '分配导师', requiresAuth: true, permissionKey: 'graduationDesign.mentor.manage' } },
    { path: 'mentors/:id/edit', name: 'graduation-mentor-edit', component: () => import('@/modules/graduation/views/GraduationMentorFormView.vue'), meta: { moduleCode: 'GRADUATION', title: '编辑导师', requiresAuth: true, permissionKey: 'graduationDesign.mentor.manage' } },
    { path: 'mentors/:id/eval', name: 'graduation-mentor-eval', component: () => import('@/modules/graduation/views/GraduationMentorEvalView.vue'), meta: { moduleCode: 'GRADUATION', title: '导师评价', requiresAuth: true, permissionKey: 'graduationDesign.mentor.manage' } },
    { path: 'mentors/:id', name: 'graduation-mentor-detail', component: () => import('@/modules/graduation/views/GraduationMentorDetailView.vue'), meta: { moduleCode: 'GRADUATION', title: '导师详情', requiresAuth: true, permissionKey: 'graduationDesign.mentor.manage' } },
    { path: 'mentors', name: 'graduation-mentors', component: () => import('@/modules/graduation/views/GraduationMentorListView.vue'), meta: { moduleCode: 'GRADUATION', title: '导师管理与分配', requiresAuth: true, permissionKey: 'graduationDesign.mentor.manage' } },
    ...
    { path: 'review-tasks', name: 'graduation-review-tasks', component: () => import('@/modules/graduation/views/GraduationDefenseGradeView.vue'), meta: { moduleCode: 'GRADUATION', title: '评阅任务', defaultPanel: 'review', requiresAuth: true, permissionKey: 'graduationDesign.review.view' } },
