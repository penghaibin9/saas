  ...
  children: [
    {
      ...
      meta: { moduleCode: 'ORIENTATION', title: '数字迎新管理看板', requiresAuth: true, permissionKey: 'studentAffairs.orientation.view' }
    },
    {
      path: 'batches',
    ...
    },
    {
      ...
      meta: { moduleCode: 'ORIENTATION', title: '绿色通道', requiresAuth: true, permissionKey: 'studentAffairs.orientation.view' }
    },
    {
      path: 'no-show',
      name: 'orientation-no-show',
      component: () => import('@/views/admin/orientation/OrientationNoShowView.vue'),
      meta: { moduleCode: 'ORIENTATION', title: '未报到学生', requiresAuth: true, permissionKey: 'studentAffairs.orientation.view' }
    },
    {
      path: 'statistics',
      name: 'orientation-statistics',
      component: () => import('@/views/admin/orientation/OrientationStatsView.vue'),
      meta: { moduleCode: 'ORIENTATION', title: '迎新统计', requiresAuth: true, permissionKey: 'studentAffairs.orientation.view' }
    },
    {
      path: 'verify',
      name: 'orientation-verify',
      component: () => import('@/views/admin/orientation/OrientationVerifyView.vue'),
      meta: { moduleCode: 'ORIENTATION', title: '新生信息核验', requiresAuth: true, permissionKey: 'studentAffairs.orientation.view' }
    },
    {
      path: 'qualification',
    ...
    },
    {
      ...
      meta: { moduleCode: 'ORIENTATION', title: '新生数据', requiresAuth: true, permissionKey: 'studentAffairs.orientation.view' }
    },
    {
      path: 'flow-config',
      name: 'orientation-flow-config',
      component: () => import('@/views/admin/orientation/OrientationFlowConfigView.vue'),
      meta: { moduleCode: 'ORIENTATION', title: '报到流程配置', requiresAuth: true, permissionKey: 'studentAffairs.orientation.view' }
    },
    {
      path: 'dorm-preassign',
    ...
    },
    {
      ...
      meta: { moduleCode: 'ORIENTATION', title: '现场报到点', requiresAuth: true, permissionKey: 'studentAffairs.orientation.view' }
    },
    {
      path: 'notices',
      name: 'orientation-notices',
      component: () => import('@/views/admin/orientation/OrientationNoticeView.vue'),
      meta: { moduleCode: 'ORIENTATION', title: '迎新通知', requiresAuth: true, permissionKey: 'studentAffairs.orientation.view' }
    },
    {
      path: 'archive',
      name: 'orientation-archive',
      component: () => import('@/views/admin/orientation/OrientationArchiveView.vue'),
      meta: { moduleCode: 'ORIENTATION', title: '迎新归档', requiresAuth: true, permissionKey: 'studentAffairs.orientation.view' }
    },
    {
      path: 'students',
    ...
    },
    {
      ...
      meta: { moduleCode: 'ORIENTATION', title: '新生报到详情', requiresAuth: true, permissionKey: 'studentAffairs.orientation.view' }
    },
    {
      path: 'progress',
      name: 'orientation-progress',
      component: () => import('@/views/admin/orientation/RegistrationProgressView.vue'),
      meta: { moduleCode: 'ORIENTATION', title: '报到进度跟踪', requiresAuth: true, permissionKey: 'studentAffairs.orientation.view' }
    },
    {
      path: 'payment',
      name: 'orientation-payment',
      component: () => import('@/views/admin/orientation/PaymentGreenChannelView.vue'),
      meta: { moduleCode: 'ORIENTATION', title: '缴费与绿色通道', requiresAuth: true, permissionKey: 'studentAffairs.orientation.view' }
    },
    {
      path: 'materials',
      name: 'orientation-materials',
      component: () => import('@/views/admin/orientation/OrientationMaterialReviewView.vue'),
      meta: { moduleCode: 'ORIENTATION', title: '迎新材料审核', requiresAuth: true, permissionKey: 'studentAffairs.orientation.view' }
    },
    {
      path: 'dorm',
    ...
    },
    {
      ...
      meta: { moduleCode: 'ORIENTATION', title: '迎新异常学生', requiresAuth: true, permissionKey: 'studentAffairs.orientation.view' }
    }
  ]
}
