...
export const NAV_PLAN = [
  ...
  grp('student-affairs', '学工中心', 'studentAffairs', [
    ...
    mod('sa-stats', '学工统计', '/admin/student-affairs/stats', [
      I('学工统计总览', '/admin/student-affairs/stats'),
      ...P('学生结构统计', '请假统计', '奖助统计', '心理关注统计', '活动统计',
        '第二课堂统计', '辅导员工作统计', '学院对比分析', '导出报表')
    ]),
   ...
   * 2026-07-09 按三家成熟商业系统对标重新分组（详见 docs/毕业设计中心/毕业设计中心-施工与验收归档.md §导航重构对标）。
