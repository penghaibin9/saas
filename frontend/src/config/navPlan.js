...
export const NAV_PLAN = [
  ...
  grp('internship', '岗位实习中心', 'internship', [
    ...
    mod('in-match-assign', '申请与落岗', '/admin/internship/applications', [
      ...
      H('导师分配', '/admin/internship/students?panel=mentor', 'internship.student.view', 'TASK_QUEUE'),
      ...
      H('分配记录', '/admin/internship/assignment-logs', 'internship.match.log.view', 'ANALYTICS_VIEW'),
    ...
    mod('in-attendance-leave', '实习过程', '/admin/internship/attendance', [
      I('考勤与异常', '/admin/internship/attendance?panel=checkins', 'internship.attendance.view', 'WORKBENCH'),
      H('异常核验', '/admin/internship/attendance?panel=exceptions', 'internship.attendance.view', 'TASK_QUEUE', { workspacePaths: ['/admin/internship/exceptions'] }),
      I('请假与返岗', '/admin/internship/leaves?panel=pending', 'internship.leave.view', 'TASK_QUEUE'),
      H('计划任务', '/admin/internship/plans', 'internship.plan.view', 'CONFIG_VIEW'),
      I('报告与任务', '/admin/internship/reports?panel=review', 'internship.report.view', 'TASK_QUEUE', { workspacePaths: ['/admin/internship/process-reports', '/admin/internship/plans'] }),
      I('指导与巡访', '/admin/internship/guidance?panel=guidance', 'internship.guidance.view', 'WORKBENCH', { workspacePaths: ['/admin/internship/guidance-plan'] }),
      H('指导计划', '/admin/internship/guidance-plan', 'internship.guidance.view', 'CONFIG_VIEW'),
