...
export const NAV_PLAN = [
  ...
  grp('student-affairs', '学工中心', 'studentAffairs', [
    ...
    mod('sa-mental-risk', '心理与危机预警', null, P(
      '心理与预警看板', '心理测评', '测评结果', '重点关注学生', '咨询预约', '咨询记录',
      '危机预警', '危机干预', '转介记录', '回访记录', '心理档案',
      '风险学生', '学业风险', '请假异常风险', '夜不归宿风险', '违纪风险', '经济困难风险',
      '实习异常风险', '多维风险合并', '风险处置', '风险跟进', '风险关闭', '风险规则配置',
      '心理权限审计', '心理与风险统计'
    )),
    mod('sa-talks', '谈心谈话与家校', null, P(
      '谈话计划', '谈话记录', '重点学生谈话', '风险学生谈话', '谈话跟进',
      '待回访学生', '批量导入谈话', '谈话统计', '谈话归档',
      '家长与联系人', '家校联系记录', '家校通知与回执', '紧急联系', '家长授权记录', '家校统计'
    )),
    ...
    mod('sa-second-class', '第二课堂与素质拓展', null, P(
      '素质拓展看板',
      '活动发布', '活动报名审核', '活动签到', '活动评价',
      '第二课堂项目库', '学时/积分认定', '积分规则', '积分台账', '学生积分查询', '证书生成',
      '社团管理', '社团活动审核', '学生会与学生组织', '组织考核',
      '团组织管理', '主题团日', '推优入党',
      '素质拓展统计', '素质拓展归档'
    )),
