...
import {
  ...
  GRADUATION_TOPIC_PROPOSAL_MAP_DOC,
  GRADUATION_GUIDANCE_MIDTERM_MAP_DOC,
  GRADUATION_FINAL_DEFENSE_MAP_DOC,
  GRADUATION_SCORE_RISK_ARCHIVE_MAP_DOC
} from '@/config/help/graduationHelpDocs'
import {
  INTERNSHIP_OVERVIEW_DOC,
  INTERNSHIP_RELATIONSHIP_MAP_DOC,
  INTERNSHIP_START_ONBOARDING_MAP_DOC,
  INTERNSHIP_DAILY_GUIDANCE_MAP_DOC,
  INTERNSHIP_RISK_CHANGE_MAP_DOC,
  INTERNSHIP_SCORE_ARCHIVE_MAP_DOC
} from '@/config/help/internshipHelpDocs'
...
import {
  ...
  STUDENT_AFFAIRS_RELATIONSHIP_OVERVIEW_DOC,
  STUDENT_AFFAIRS_CAMPUS_LIFE_MAP_DOC,
  STUDENT_AFFAIRS_RISK_CARE_MAP_DOC,
  STUDENT_AFFAIRS_GROWTH_ARCHIVE_MAP_DOC
} from '@/config/help/studentAffairsHelpDocs'
import {
  ACADEMIC_AFFAIRS_HELP_DOCS,
  ACADEMIC_AFFAIRS_OVERVIEW_DOC,
  ACADEMIC_AFFAIRS_RELATIONSHIP_OVERVIEW_DOC,
  ACADEMIC_AFFAIRS_TEACHING_PREPARATION_MAP_DOC,
  ACADEMIC_AFFAIRS_SCHEDULE_SELECTION_MAP_DOC,
  ACADEMIC_AFFAIRS_EXAM_MAP_DOC,
  ACADEMIC_AFFAIRS_GRADE_WARNING_MAP_DOC,
  ACADEMIC_AFFAIRS_STUDENT_GRADUATION_MAP_DOC,
  ACADEMIC_AFFAIRS_QUALITY_ARCHIVE_MAP_DOC
} from '@/config/help/academicAffairsHelpDocs'
...
export const HELP_DOCS = [
  ...
  INTERNSHIP_OVERVIEW_DOC,
  {
    ...
    points: [
      '工作台按当前真实身份展示待办与常用入口；领导驾驶舱仅对有数据中心权限的身份可见。',
      '在「我的工作台」右侧可管理「我的常用」：收藏快捷入口、隐藏不需要的汇总磁贴；偏好按账号保存在服务器，换电脑仍有效。',
      '点「恢复默认」可清空当前角色的个人布局，回到系统配方。'
    ]
  },
  {
...
export const HELP_SECTIONS = [
  { key: 'aa-overview', label: '教务中心 · 教师一眼通', items: [ACADEMIC_AFFAIRS_RELATIONSHIP_OVERVIEW_DOC, ACADEMIC_AFFAIRS_TEACHING_PREPARATION_MAP_DOC, ACADEMIC_AFFAIRS_SCHEDULE_SELECTION_MAP_DOC, ACADEMIC_AFFAIRS_EXAM_MAP_DOC, ACADEMIC_AFFAIRS_GRADE_WARNING_MAP_DOC, ACADEMIC_AFFAIRS_STUDENT_GRADUATION_MAP_DOC, ACADEMIC_AFFAIRS_QUALITY_ARCHIVE_MAP_DOC, ACADEMIC_AFFAIRS_OVERVIEW_DOC] },
  { key: 'sa-overview', label: '学工中心 · 老师一眼通', items: [STUDENT_AFFAIRS_RELATIONSHIP_OVERVIEW_DOC, STUDENT_AFFAIRS_CAMPUS_LIFE_MAP_DOC, STUDENT_AFFAIRS_RISK_CARE_MAP_DOC, STUDENT_AFFAIRS_GROWTH_ARCHIVE_MAP_DOC, STUDENT_AFFAIRS_OVERVIEW_DOC] },
  { key: 'gd-overview', label: '毕业设计中心 · 老师一眼通', items: [GRADUATION_RELATIONSHIP_MAP_DOC, GRADUATION_TOPIC_PROPOSAL_MAP_DOC, GRADUATION_GUIDANCE_MIDTERM_MAP_DOC, GRADUATION_FINAL_DEFENSE_MAP_DOC, GRADUATION_SCORE_RISK_ARCHIVE_MAP_DOC, GRADUATION_OVERVIEW_DOC] },
  { key: 'in-overview', label: '岗位实习中心 · 老师一眼通', items: [INTERNSHIP_RELATIONSHIP_MAP_DOC, INTERNSHIP_START_ONBOARDING_MAP_DOC, INTERNSHIP_DAILY_GUIDANCE_MAP_DOC, INTERNSHIP_RISK_CHANGE_MAP_DOC, INTERNSHIP_SCORE_ARCHIVE_MAP_DOC, INTERNSHIP_OVERVIEW_DOC] },
  { key: 'docs', label: '功能帮助', items: HELP_DOCS.filter((item) => ![ACADEMIC_AFFAIRS_RELATIONSHIP_OVERVIEW_DOC.id, ACADEMIC_AFFAIRS_TEACHING_PREPARATION_MAP_DOC.id, ACADEMIC_AFFAIRS_SCHEDULE_SELECTION_MAP_DOC.id, ACADEMIC_AFFAIRS_EXAM_MAP_DOC.id, ACADEMIC_AFFAIRS_GRADE_WARNING_MAP_DOC.id, ACADEMIC_AFFAIRS_STUDENT_GRADUATION_MAP_DOC.id, ACADEMIC_AFFAIRS_QUALITY_ARCHIVE_MAP_DOC.id, ACADEMIC_AFFAIRS_OVERVIEW_DOC.id, STUDENT_AFFAIRS_RELATIONSHIP_OVERVIEW_DOC.id, STUDENT_AFFAIRS_CAMPUS_LIFE_MAP_DOC.id, STUDENT_AFFAIRS_RISK_CARE_MAP_DOC.id, STUDENT_AFFAIRS_GROWTH_ARCHIVE_MAP_DOC.id, STUDENT_AFFAIRS_OVERVIEW_DOC.id, GRADUATION_RELATIONSHIP_MAP_DOC.id, GRADUATION_TOPIC_PROPOSAL_MAP_DOC.id, GRADUATION_GUIDANCE_MIDTERM_MAP_DOC.id, GRADUATION_FINAL_DEFENSE_MAP_DOC.id, GRADUATION_SCORE_RISK_ARCHIVE_MAP_DOC.id, GRADUATION_OVERVIEW_DOC.id, INTERNSHIP_RELATIONSHIP_MAP_DOC.id, INTERNSHIP_START_ONBOARDING_MAP_DOC.id, INTERNSHIP_DAILY_GUIDANCE_MAP_DOC.id, INTERNSHIP_RISK_CHANGE_MAP_DOC.id, INTERNSHIP_SCORE_ARCHIVE_MAP_DOC.id, INTERNSHIP_OVERVIEW_DOC.id].includes(item.id)) },
