        ...
        <div class="yk-shell yk-sales-hero-grid">
          <div class="yk-sales-copy">
            ...
            <div class="yk-hero-actions">
              ...
              <router-link v-if="page.path !== '/contact'" class="yk-button yk-button-ghost" to="/contact">提交合作需求</router-link>
      ...
      <section class="yk-final-cta">
        <div class="yk-shell yk-final-inner">
          ...
          <div class="yk-final-actions">
            ...
            <router-link v-if="page.path !== '/contact'" class="yk-button yk-button-ghost" to="/contact">联系跃科</router-link>
          </div>
        </div>
      </section>
    </main>
...
@media (max-width: 980px) { .yk-sales-hero-grid { grid-template-columns: 1fr; } .yk-sales-related-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); } }
@media (max-width: 680px) { .yk-sales-hero { padding-top: 64px; } .yk-sales-copy h1 { font-size: 38px; letter-spacing: -1px; } .yk-sales-evidence-grid, .yk-sales-related-grid { grid-template-columns: 1fr; } }
</style>
