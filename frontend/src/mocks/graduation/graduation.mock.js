...
export const permissionActions = {
  ...
  exportDefense: { visible: true, allowed: true, reason: '' },
    ...
    submitPlagiarism: { visible: true, allowed: true, reason: '' },
    setPlagiarismResult: { visible: true, allowed: true, reason: '' },
    reviewPlagiarismDispute: { visible: true, allowed: true, reason: '' },
    assignReview: { visible: true, allowed: true, reason: '' },
    submitReview: { visible: true, allowed: true, reason: '' },
    returnReview: { visible: true, allowed: true, reason: '' },
  ...
  reviewGrade: { visible: true, allowed: true, reason: '' },
  withdrawGrade: { visible: true, allowed: true, reason: '' },
