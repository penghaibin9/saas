...
test('collaboration-only home never invokes the recruitment dashboard guard',()=>{assert.match(home,/context\.recruitmentContextReady\s*\?\s*enterpriseInternshipApi\.dashboard\(\)\s*:\s*Promise\.resolve\(null\)/)})
