...
const loading=ref(''),error=ref(''),confirming=ref(''),withdrawReason=ref('')
...
function requestWithdrawAccept(){
  if(!props.campaignWritable||!lockedAccept.value)return
