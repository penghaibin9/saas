  ...
  <section class="ep-page wide">
    ...
    <template v-else>
      ...
      <div class="pipeline-shell ep-card">
        ...
        <div class="scope-note"><span class="scope-dot"></span>当前只开放处理状态筛选；岗位、专业、年级等组合筛选将在学校端开放对应查询能力后提供。</div>
      </div>
