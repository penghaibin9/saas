...
<style scoped>.wide{max-width:1400px}.role-denied{padding:30px;max-width:760px}.role-denied h2{margin:14px 0 8px;font-size:20px}.role-denied p{margin:0;color:var(--t3);line-height:1.7}.history-note{padding:12px 14px;margin-bottom:12px;background:var(--warn-bg);color:var(--warn-fg);border-radius:8px;font-size:13px}.pipeline{display:flex;gap:2px;border-bottom:1px solid var(--line);margin-bottom:10px;background:#fff;border-radius:10px 10px 0 0;overflow:auto}.pipeline button{border:0;background:transparent;min-height:46px;padding:0 14px;color:var(--t2);border-bottom:2px solid transparent;white-space:nowrap}.pipeline button.active{color:var(--pri);border-bottom-color:var(--pri);font-weight:700}.scope-note{margin:0 0 12px;color:var(--t3);font-size:12px}.workbench{display:grid;grid-template-columns:420px minmax(0,1fr);height:calc(100vh - 245px);min-height:360px;overflow:hidden}.candidates{border-right:1px solid var(--line);height:100%;max-height:none;overflow:auto}.pager{position:sticky;bottom:0;display:flex;align-items:center;justify-content:space-between;gap:8px;padding:10px;border-top:1px solid var(--line);background:#fff;font-size:12px;color:var(--t3)}.pager .ep-btn{min-height:34px;padding:0 10px}.detail-pane{position:relative;min-width:0;min-height:0;height:100%;overflow:hidden;background:#fff}.mobile-back{display:none}@media(max-width:1279px) and (min-width:1000px){.workbench{grid-template-columns:360px minmax(0,1fr)}}@media(max-width:999px){.workbench{display:block;height:auto;min-height:0}.candidates{height:auto;max-height:none;border-right:0}.detail-pane{display:none;height:auto;overflow:visible}.workbench.showDetail .candidates{display:none}.workbench.showDetail .detail-pane{display:block}.mobile-back{display:block;width:100%;height:44px;border:0;border-bottom:1px solid var(--line);background:#fff;text-align:left;padding:0 16px;color:var(--pri);font-weight:600}}</style>
