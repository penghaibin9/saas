...
.tasks,.history{padding:19px 20px;margin-bottom:0}.today-first{margin:18px 0;border-color:var(--pri-200);box-shadow:0 12px 30px rgba(40,78,150,.08)}.card-head{display:flex;justify-content:space-between;align-items:flex-start;gap:12px;margin-bottom:4px}.card-head>div>span{display:block;font-size:10px;color:var(--t3);font-weight:700;letter-spacing:.08em;margin-bottom:3px}.card-head .ep-section-title{margin-bottom:0}.count-badge{min-width:26px;height:26px;border-radius:999px;display:grid;place-items:center;background:var(--pri-50);color:var(--pri);font-size:11px;font-weight:800}.compact{padding:32px 10px}.task{display:flex;justify-content:space-between;gap:20px;align-items:center;padding:15px 0;border-top:1px solid var(--line)}.task:first-of-type{border-top:0}.task-copy{min-width:0}.task-why{display:block;margin-bottom:4px;color:var(--pri);font-size:10px;font-weight:700}.task b{font-size:13px}.task p{margin:5px 0 0;color:var(--t3);font-size:12px;line-height:1.55}.task-meta{display:flex;flex-wrap:wrap;gap:5px 14px;margin-top:8px;color:var(--t4);font-size:10px;line-height:1.45}.task a{text-decoration:none;flex:0 0 auto}.history{margin-top:18px}.history-row{padding:14px 0;border-top:1px solid var(--line)}.history-row:first-of-type{border-top:0}.history-row>div{display:flex;align-items:center;gap:8px}.history-row b{font-size:12px;color:var(--t1);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.history-row span{font-size:9px;background:var(--pri-50);color:var(--pri);padding:2px 6px;border-radius:999px}.history-row small{display:block;margin-top:5px;font-size:10px;color:var(--t3)}
@media(max-width:1050px){.metrics{grid-template-columns:repeat(2,minmax(0,1fr))}.hero-note{display:none}}
@media(max-width:640px){.hero-head{margin-bottom:16px}.metrics{gap:9px}.metric{min-height:104px;padding:14px}.metric strong{font-size:24px}.section-head small{display:none}.task{align-items:flex-start;flex-direction:column}.task a{width:100%;text-align:center}.task-meta{flex-direction:column;gap:3px}}
</style>
