...
> **上位文档**：`docs/commercialization/00-商业化SaaS总控作战手册V1.0.md`、`docs/source-design/00-职校学生全生命周期SaaS平台开发冻结总册 V3.0-增强版.md`
...
- 业务字段、状态机、审批流以 `docs/source-design/` 为准。
- 商业化售卖、套餐、授权以 `docs/commercialization/` 为准。
