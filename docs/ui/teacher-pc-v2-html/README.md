...
成绩管理、成绩审核发布更正、学籍管理、注册管理、学籍异动办理、学院专业班级、学年学期、校历节次、课程库、培养方案、教学任务、课表管理、调停课、选课管理。

## 最近新增

选课管理覆盖批次生命周期、课程供给、容量、选课轮次、抽签、开放监控、低人数停开、正式名单锁定、学生自助选退、补选指引、归档查询和带用途审计的 XLSX 导出。
