...
> 依据：`docs/05-数据接口权限与安全/database/00-数据库设计冻结总册.md`（DB 基线）+ UI 设计稿（PC/小程序）+ 业务深化文档 01–12 + 11 权限与流程 §12 + 08B 教师移动 §11
...
> 本册及本套 11 份文档为纯契约设计，未写任何代码、未连库、未改 src。各接口的 DB 映射以 `docs/05-数据接口权限与安全/database/00-数据库设计冻结总册.md` 为准。
