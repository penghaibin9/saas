...
7. **对应 commit 记录位**：组件落地后在本表回填，并写进 `docs/06-开发施工与质量验收/施工记录/`。
...
2. 回填「commit 记录位」；  
3. 在 `docs/06-开发施工与质量验收/施工记录/` 追加施工记录；  
4. 若能力不足但可交付，写进 `docs/06-开发施工与质量验收/施工记录/历史欠账.md`；  
...
| 规划文档 | `docs/02-总体架构与公共底座/公共组件/00-高校SaaS公共组件商业化底座总控表.md` |
| 盘点报告 | `docs/02-总体架构与公共底座/公共组件/公共组件-前端资产盘点报告.md` |
| 六层组件总数 | **82** |
...
> 详细说明见：`docs/02-总体架构与公共底座/公共组件/公共组件-前端资产盘点报告.md`  
...
> 在线预览：`/dev/components`。使用手册：`docs/02-总体架构与公共底座/公共组件/公共组件-使用指南总册.md` 第一篇。
...
> 使用手册：`docs/02-总体架构与公共底座/公共组件/公共组件-使用指南总册.md` 第二篇。在线预览 `/dev/components`「第三阶段」区块。
> commit：待用户确认后提交（本轮不 commit、不 push）。
...
完整《展示覆盖表》+《5 星 UI 验收表》见 `docs/02-总体架构与公共底座/公共组件/公共组件-使用指南总册.md` 第二篇附录。
