...
> **后续 AI 开发前，必须先阅读 [`docs/00-项目入口与总控/00-只看这个-项目入口.md`](../../00-项目入口与总控/00-只看这个-项目入口.md)。**
...
**路径**：`docs/04-UI与全端交互/ui/fable5-pc-final/`
...
**路径**：`docs/04-UI与全端交互/ui/fable5-miniapp-final/`
...
- `docs/04-UI与全端交互/ui/fable5-miniapp-final/小程序设计.pdf`
- `docs/04-UI与全端交互/ui/fable5-miniapp-final/职校学生全生命周期小程序.zip`
- `docs/04-UI与全端交互/ui/fable5-miniapp-final/职校学生全生命周期-小程序设计稿.html`
...
- 项目总入口（新手必读）：[`docs/00-项目入口与总控/00-只看这个-项目入口.md`](../../00-项目入口与总控/00-只看这个-项目入口.md)
