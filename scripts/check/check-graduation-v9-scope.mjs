...
const CARD_ALLOW = {
  ...
  CI_ARCH: [
    ...
    /^\.github\/workflows\/(?:playwright-production-e2e|graduation-browser-gate|graduation-v6-gold-candidate|graduation-w77-exact-head-e2e)\.yml$/,
    ...
    /^e2e\/lib\/(?:api-fixture|graduation-role-accounts|graduation-scenario-fixture)\.mjs$/,
    ...
    /^frontend\/tests\/graduation\.v6-frontend-review\.contract\.test\.mjs$/,
  ],
  E2E_PREREQ: [
  ...
  U7: [
    ...
    /^backend\/app\/modules\/graduation\/routers\/graduation_archive_sensitive_router\.py$/,
    /^backend\/app\/modules\/graduation\/services\/__init__\.py$/,
    /^backend\/app\/modules\/graduation\/services\/graduation_archive_(?:read_service|consistency|data_quality|batch_scale|batch_consistency)\.py$/,
    /^backend\/tests\/test_graduation_v9_u7_(?:archive_dirty_data|archive_export_paging|snapshot_dirty_guard|batch_production)\.py$/,
  ...
  U8: [
    ...
    /^miniapp\/src\/pages\/teacher\/graduation-(?:guide|taskbook)\/index\.vue$/,
