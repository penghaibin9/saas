"""Bootstrap one college-level student-affairs account for isolated Playwright CI.

E2E infrastructure only. Uses the same official identity import, user lookup,
